 ...
 * */
package com.professorvennie.machinerycraft.core.tileEntity.machines.copper;
...
public class TileEntityCopperFurnace extends TileEntityBasicSidedInventory {

    public int furnaceSpeed = 100, burnTime, currentItemBurnTime, cookTime;
