...
public class ConfigHandler {
    ...
    public static boolean spawnZinc = true;

    public static int copperRate = 15;
    public static int tinRate = 16;
    public static int silverRate = 5;
    public static int leadRate = 18;
    public static int zincRate = 10;
    ...
    public static int zincVienSize = 4;
    ...
    public static boolean spawnPlasticBiome = true;
    public static int plasticBiomeWeight = 15;
    ...
    private static void loadConfiguration() {
        ...
        spawnZinc = configuration.getBoolean("zinc Spawn", Configuration.CATEGORY_GENERAL, true, "Enables/disables the spawning of zinc veins.");
        ...
        zincRate = configuration.getInt("zinc Rate", Configuration.CATEGORY_GENERAL, 10, 1, 30, "Sets how much zinc spawns in the world");
        ...
        zincVienSize = configuration.getInt("zinc VienSize", Configuration.CATEGORY_GENERAL, 4, 1, 10, "Sets how much zinc spawns in each vien");
        ...
        spawnPlasticBiome = configuration.getBoolean("Plastic Biome", Configuration.CATEGORY_GENERAL, true, "Enables/disables the plastic biome spawning");
        plasticBiomeWeight = configuration.getInt("Plastic Biome Weight", Configuration.CATEGORY_GENERAL, 15, 1, 30, "The weight foe the spawning of the plastic biome");
