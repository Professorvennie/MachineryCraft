...
import com.professorvennie.machinerycraft.core.client.gui.book.GuiBookEntry;
import com.professorvennie.machinerycraft.core.client.gui.pages.BookRecipeMappings.EntryData;
...
public class PageRecipe extends BookPage {
    ...
    public void renderScreen(IGuiBookEntry gui, int mx, int my) {
        ...
        if (tooltipStack != null) {
            ...
            com.professorvennie.machinerycraft.core.main.helpers.RenderHelper.renderTooltip(mx, my, parsedTooltip);

            int tooltipY = 8 + tooltipData.size() * 11;

            if (tooltipEntry) {
                com.professorvennie.machinerycraft.core.main.helpers.RenderHelper.renderTooltipOrange(mx, my + tooltipY, Arrays.asList(EnumChatFormatting.GRAY + StatCollector.translateToLocal("mc.book.clickToRecipe")));
                tooltipY += 18;
            }

            if (tooltipContainerStack != null)
                com.professorvennie.machinerycraft.core.main.helpers.RenderHelper.renderTooltipOrange(mx, my + tooltipY, Arrays.asList(EnumChatFormatting.AQUA + StatCollector.translateToLocal("botaniamisc.craftingContainer"), tooltipContainerStack.getDisplayName()));
        }
