...
import com.professorvennie.machinerycraft.core.main.helpers.RenderHelper;
    ...
    public void renderRecipe(IGuiBookEntry gui, int mx, int my) {
        ...
        if (shapelessRecipe) {
            ...
            if (mx >= iconX && my >= iconY && mx < iconX + 16 && my < iconY + 16)
                RenderHelper.renderTooltip(mx, my, Arrays.asList(StatCollector.translateToLocal("mc.book.shapeless")));
        ...
        if (oreDictRecipe) {
            ...
            if (mx >= iconX && my >= iconY && mx < iconX + 16 && my < iconY + 16)
                RenderHelper.renderTooltip(mx, my, Arrays.asList(StatCollector.translateToLocal("mc.book.oredict")));
        }
