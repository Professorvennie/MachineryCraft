    ...
    public void onUpdate() {
        ...
        if (this.field_146055_aB > 0) {
            ...
            if (!this.worldObj.isRemote) {
                ...
                if (this.field_146042_b.isDead || !this.field_146042_b.isEntityAlive() || itemstack == null || !(itemstack.getItem() instanceof ItemModFishingPole) || this.getDistanceSqToEntity(this.field_146042_b) > 1024.0D) {
                    this.setDead();
