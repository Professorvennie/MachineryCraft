...
public class ModItems {
    ...
    public static void InitialiseItem() {
        ...
        emeraldchest = new ItemEmeraldArmor(1, Names.Items.EMERALD_CHEST);
        emeraldpants = new ItemEmeraldArmor(2, Names.Items.EMERALD_PANTS);
        emeraldboots = new ItemEmeraldArmor(3, Names.Items.EMERALD_BOOTS);
    }
}