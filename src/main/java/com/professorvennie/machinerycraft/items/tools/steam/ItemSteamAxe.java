...
/**
 * Created by ProfessorVennie on 10/4/2014 at 12:24 PM.
 */
public class ItemSteamAxe extends ItemAxe implements ISteamPoweredItem {

    private int capacity, steamPerUse;

    public ItemSteamAxe(String name, int capacity, int steamPerUse) {
        super(/*EnumHelper.addToolMaterial("SteamAxe", 3, 2, 14.0f, -1.0f, 10)*/ ToolMaterial.EMERALD);
    ...
    public ItemSteamAxe(ToolMaterial material, String name, int capacity, int steamPerUse) {
        super(material);
        setCreativeTab(MachineryCraft.tabMachineryCraftEquipment);
        setUnlocalizedName(name);
        this.capacity = capacity;
    ...
    /*@Override
    public boolean onBlockStartBreak(ItemStack itemStack, BlockPos pos, IBlockState state, EntityPlayer player) {
