...
public class LibGuiIds {
    ...
    public static final int GUIID_PORTABLE_COBBLEGEN = 12;
    public static final int BRONZE_FURNACE = 13;
    ...
    public static final int BRASS_GEN = 18;
    public static final int BRASS_LAVA_GEN = 19;
    public static final int WELL = 20;
    public static final int CAMPFIRE = 21;
    public static final int BRASS_CHARGER = 22;
}
