...
import com.professorvennie.machinerycraft.common.containers.ContainerBronzeSteamBoiler;
...
public class GuiBronzeSteamBoiler extends GuiBase {
    ...
    protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
        ...
        if (entity.tanks[0].getFluidAmount() > 0 || (entity.tanks[0].getFluid() != null)) {
            text.clear();
            text.add(entity.tanks[0].getFluid().getFluid().getLocalizedName());
        ...
        if (entity.tanks[1].getFluidAmount() > 0 || (entity.tanks[1].getFluid() != null)) {
            text2.clear();
            text2.add(entity.tanks[1].getFluid().getFluid().getLocalizedName());
