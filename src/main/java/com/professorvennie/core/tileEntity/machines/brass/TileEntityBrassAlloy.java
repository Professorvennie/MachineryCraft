...
import com.professorvennie.core.block.machines.brass.BlockBrassAlloySmelter;
...
public class TileEntityBrassAlloy extends TileEntityMod implements ISidedInventory{
	...
	public String getInventoryName() {
        return this.hasCustomName() ? this.getCustomName() : Names.Containers.CONTAINER_BRASS_ALLOY;
