...
public class TileEntityironOxideGrinder extends TileEntityMod implements ISidedInventory {
	...
	public String getInventoryName() {
        return this.hasCustomName() ? this.getCustomName() : Names.Containers.CONTAINER_IRONOXIDE_GRINDER;
    }
	...
	public void updateEntity(){
    	...
    	if (!this.worldObj.isRemote){
			...
			if(flag != this.hasPower()){
				flag1 = true;
				BlockIronoxideGrinder.updateBlockState(this.cookTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord, ModBlocks.ironOxideGrinderActive, ModBlocks.ironOxideGrinderIdle);
			}
