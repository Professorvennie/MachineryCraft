...
import com.professorvennie.core.gui.containers.ContainerWasher;
...
public static final ResourceLocation texture = new ResourceLocation(LibStrings.MODID, "textures/gui/Washer.png");
	...
	public void drawGuiContainerForegroundLayer(int par1, int par2){
		String name = this.Washer.isInvNameLocalized() ? this.Washer.getInvName() : I18n.format(this.Washer.getInvName(), MainRegistry.instance);
		
		this.fontRendererObj.drawString(name, this.xSize / 2 - this.fontRendererObj.getStringWidth(name) / 2, 6, 4210752);
		this.fontRendererObj.drawString(I18n.format("contaniner.inventory", MainRegistry.instance), 30, this.ySize - 96 + 2, 4210752);
		this.fontRendererObj.drawString(I18n.format("In", MainRegistry.instance), 141, this.ySize - 116, 4210752);
		this.fontRendererObj.drawString(I18n.format("Out", MainRegistry.instance), 135, this.ySize - 99, 4210752);
