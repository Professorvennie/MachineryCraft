...
import com.professorvennie.core.gui.pages.BookRecipeMappings.EntryData;
	...
	public void renderScreen(IGuiBookEntry gui, int mx, int my) {
		...
		if(tooltipStack != null) {
			...
			if(tooltipContainerStack != null)
				com.professorvennie.core.main.helpers.RenderHelper.renderTooltipGreen(mx, my + tooltipY, Arrays.asList(EnumChatFormatting.AQUA + StatCollector.translateToLocal("botaniamisc.craftingContainer"), tooltipContainerStack.getDisplayName()));
		}
