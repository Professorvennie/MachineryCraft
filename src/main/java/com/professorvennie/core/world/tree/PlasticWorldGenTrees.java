 ...
 * */
package com.professorvennie.core.world.tree;
...
public class PlasticWorldGenTrees extends WorldGenAbstractTree {
    ...
    public PlasticWorldGenTrees(boolean par1)
    {
     ...
     */
    public PlasticWorldGenTrees(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
