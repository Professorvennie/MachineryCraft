...
public class BlockIronoxideAlloy extends BlockContainer implements IBookable{
	...
	public static void updateGrinderBlockState(boolean active, World worldObj,
		...
		if (active) {
			worldObj.setBlock(xCoord, yCoord, zCoord, ModBlocks.ironOxideAlloyActive);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord, ModBlocks.ironOxideAlloyIdle);
		}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		if (itemstack.hasDisplayName()) {
			((TileEntityIronOxideAlloy) world.getTileEntity(x, y, z)) .setGuiDisplayName(itemstack.getDisplayName());
		}
	}
