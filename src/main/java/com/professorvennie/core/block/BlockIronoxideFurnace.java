...
public class BlockIronoxideFurnace extends BlockContainer  {
	...
	public BlockIronoxideFurnace(boolean isActive) {
		...
		if(!isActive){
			this.setBlockName(LibNames.ironOxideFurnaceIdle);
			this.setCreativeTab(MainRegistry.tabMachineryCraft);
		}
		if(isActive){
			this.setLightLevel(0.9F);
			this.setBlockName(LibNames.ironOxideFurnaceActive);
		}
	...
	public void registerBlockIcons(IIconRegister iiconRegister) {
		...
		this.iconFront = iiconRegister.registerIcon(LibStrings.MODID+ ":" + (this.isActive ? "ironoxide_furnace_Active" : "ironoxide_furnace_idle"));
	}
