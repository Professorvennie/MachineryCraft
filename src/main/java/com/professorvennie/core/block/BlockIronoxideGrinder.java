...
public class BlockIronoxideGrinder extends BlockContainer  {
	...
	public BlockIronoxideGrinder(boolean isActive) {
		...
		if(!isActive){
			this.setBlockName(LibNames.ironOxideGrinderIdle);
			this.setCreativeTab(MainRegistry.tabMachineryCraft);
		}
		if(isActive){
			this.setLightLevel(0.9F);
			this.setBlockName(LibNames.ironOxideGrinderActive);
		}
	...
	public void registerBlockIcons(IIconRegister iiconRegister) {
		...
		this.iconFront = iiconRegister.registerIcon(LibStrings.MODID+ ":" + (this.isActive ? "ironoxide_grinder_front_active" : "ironoxide_grinder_front_idle"));
	}
