...
public class ContainerGoldoxideAlloy extends Container {

    private TileEntityGoldOxideAlloy Alloy;

    public ContainerGoldoxideAlloy(InventoryPlayer inventory, TileEntityGoldOxideAlloy entity) {
        this.Alloy = entity;
