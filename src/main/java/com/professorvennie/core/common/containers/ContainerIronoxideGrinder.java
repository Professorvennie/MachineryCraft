...
public class ContainerIronoxideGrinder extends Container {
	...
	private TileEntityironOxideGrinder Grinder;

	public ContainerIronoxideGrinder(InventoryPlayer inventory, TileEntityironOxideGrinder entity) {
		this.Grinder = entity;
