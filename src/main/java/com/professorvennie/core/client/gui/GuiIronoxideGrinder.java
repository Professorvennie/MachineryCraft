...
import com.professorvennie.core.common.containers.ContainerIronoxideGrinder;
...
public class GuiIronoxideGrinder extends GuiContainer{
	public static final ResourceLocation texture = new ResourceLocation(Reference.MOD_ID, "textures/gui/Ironoxide_Grinder.png");
	
	public TileEntityironOxideGrinder Grinder;
	 protected int mouseX = 0, mouseY = 0;

	public GuiIronoxideGrinder(InventoryPlayer inventory, TileEntityironOxideGrinder entity) {
		super(new ContainerIronoxideGrinder(inventory, entity));
