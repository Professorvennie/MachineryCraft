...
import com.professorvennie.core.common.containers.ContainerBrassFurnace;
...
public class GuiBrassFurnace extends GuiContainer{
	...
	public GuiBrassFurnace(InventoryPlayer inventoryPlayer, TileEntityBrassFurnace entity) {
		super(new ContainerBrassFurnace(inventoryPlayer, entity));
