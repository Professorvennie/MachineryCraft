...
import com.professorvennie.core.common.containers.ContainerBrassGrinder;
...
public class GuiBrassGrinder extends GuiContainer{
	...
	public GuiBrassGrinder(InventoryPlayer inventory, TileEntityBrassGrinder entity) {
		super(new ContainerBrassGrinder(inventory, entity));
