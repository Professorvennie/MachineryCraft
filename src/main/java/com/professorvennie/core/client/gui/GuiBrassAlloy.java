...
import com.professorvennie.core.common.containers.ContainerBrassAlloy;
...
public class GuiBrassAlloy extends GuiContainer{
...
public static final ResourceLocation texture = new ResourceLocation(Reference.MOD_ID, "textures/gui/Ironoxide_Alloy.png");
	...
	public GuiBrassAlloy(InventoryPlayer inventory, TileEntityBrassAlloy entity) {
		super(new ContainerBrassAlloy(inventory, entity));
	...
	public void drawGuiContainerForegroundLayer(int par1, int par2){
		String name = StatCollector.translateToLocal(Alloy.getInventoryName());
