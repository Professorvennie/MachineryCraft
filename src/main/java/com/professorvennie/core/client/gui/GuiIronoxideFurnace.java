...
import com.professorvennie.core.common.containers.ContainerIronoxideFurnace;
...
public class GuiIronoxideFurnace extends GuiContainer{
	...
	public GuiIronoxideFurnace(InventoryPlayer inventoryPlayer, TileEntityIronOxideFurnace entity) {
		super(new ContainerIronoxideFurnace(inventoryPlayer, entity));
